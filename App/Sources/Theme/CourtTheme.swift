...
enum CourtTheme: String, CaseIterable, Identifiable, Codable {
    ...
    var subtitle: String {
        switch self {
        case .wimbledon: return "Green court"
        case .rolandGarros: return "Terracotta"
        case .usOpen: return "Blue hard court"
        case .melbourne: return "Cool blue"
        }
    }
